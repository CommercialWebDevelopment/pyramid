...
<div class="row-fluid">
    <div class="span12">
        <div class="span6 offset4">
            <h4>Регистрация нового участника</h4>
        </div>
    </div>
</div>
            ...
            <div class="span6">
                <div class="row-fluid control-group error">
                    ...
                    <div class="span7 controls">
                        <input id="surname" type="text" class="form-field" onkeyup="Registration.validateTextField(this, value)">
                    </div>
                </div>
                <div class="row-fluid control-group error">
                    <div class="span5">
                ...
                <div class="row-fluid control-group error">
                    ...
                    <div class="span7 controls">
                        <div class="input-prepend form-field">
                            ...
                            <input id="email" name="email" type="text" class="" onkeyup="Registration.validateEMailField(this, value)">
                        </div>
                    </div>
                </div>
                <div class="row-fluid control-group error">
                ...
                <div class="row-fluid control-group error">
                    <div class="span5">
                        <label for="confirm_password" class="required_label form-field">Подтвердите пароль<span class="asterisk_red">*</span></label>
                    </div>
                    <div class="span7 controls">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="span3 offset9">
                    <button id="registration-button" class="btn btn-primary" type="submit">Регистрация</button>
                </div>
            </div>
        </div>
    </div>
