...
<div class="row-fluid">
    <div class="span12" id="admin-menu">
        <ul class="nav nav-tabs">
            <li class="active"><a href="<c:url value="/pyramid/admin/user_settings"/>" data-toogle="tab"><spring:message
                    code="users"/></a></li>
            ...
            <li><a href="<c:url value="/pyramid/admin/contact_settings"/>" data-toogle="tab"><spring:message
                    code="contacts"/></a></li>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <div id="add-user-form" style="width: 800px" class="modal hide fade" tabindex="-1" role="dialog"
             aria-labelledby="add-user-form-abel" aria-hidden="true">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span4">
                                <div class="span6 offset3">
                                    <a href="#" class="thumbnail" id="user-details" data-toggle="popover"
                                       data-placement="left">
